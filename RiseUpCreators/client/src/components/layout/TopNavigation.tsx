    ...
    <header className="flex items-center justify-between p-3 md:p-6 bg-spotify-black/95 backdrop-blur-md border-b border-gray-700/50 sticky top-0 z-30">
      ...
      <div className="md:hidden flex items-center justify-between w-full">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent
            align="end"
            className="w-48 bg-spotify-light-gray border-gray-700"
          >
            <DropdownMenuItem
      ...
      <div className="hidden md:flex">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              variant="ghost"
              className="flex items-center space-x-3 bg-black/50 hover:bg-gray-800 px-3 py-2 rounded-full"
            >
              <div className="w-8 h-8 rounded-full overflow-hidden border-2 border-white/20">
                {user?.profilePicture ? (
                  <img
